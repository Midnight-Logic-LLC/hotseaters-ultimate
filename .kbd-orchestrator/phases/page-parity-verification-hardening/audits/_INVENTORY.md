...
|-------|-----------|-------|----|----|------|
| Landing/Home | `landing/pages/landing-page.tsx` | `/` `/Landing` | drift | PENDING | 🔴 79% (deployed port blank — likely stale deploy) |
| Pricing | `marketing/pages/pricing-page.tsx` | `/Pricing` | drift | PENDING | 🔴 79% (same) |
